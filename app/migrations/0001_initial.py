# Generated by Django 4.2.4 on 2023-08-13 01:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(blank=True, to='app.comment')),
                ('users_disliked', models.ManyToManyField(blank=True, related_name='podcast_disliked', to=settings.AUTH_USER_MODEL)),
                ('users_liked', models.ManyToManyField(blank=True, related_name='podcast_liked', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
